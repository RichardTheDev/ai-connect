...
//       </h1>
//       <div className="body-panel">test</div>
//     </div>
//   );
// };
...
import { TableProps } from "../../widgets/genericList/GenericList";
    ...
    <div className="first">
      ...
      <div className="dashboard">
        <div className="row">
          ...
          <div className="body-data">
            <GenericPlot fig={figData}></GenericPlot>
          </div>
        </div>
        <div className="row">
          <h2>test</h2>

          <div className="body-data">test</div>
          <h2>test</h2>
